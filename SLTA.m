function SLTA (Sx_in,size_block,overlap,windows)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%*FUNCION PARA DETERMINAR LA SLTA (RESPUESTA EN FRECUENCIA A LARGO PLAZO)*%
% Entradas:                              Salidas:                         %
%          Sx_in: Señal de entrada.              -El espectro SLTA global %
%          size_block: Tamaño de bloque.                                  %
...
for i =1:numero_ventanas
   ...
   case 3
    ...
    var = fft(bloque_enventanado);
    var = abs (var(1:Nf));                 %Sólo nos quedamos con el espectro real     
...
% 18. Ordenamos la LTA para obtener la SLTA %
SLTA_global = sort (LTA_dB, 'descend');
subplot(2,1,2);
x = 0:Nf-1;
plot (x,SLTA_global, 'k','LineWidth', 5);
title ('Espectro a largo plazo ordenado (SLTA)')
xlabel('Frecuencia (Índice)')
ylabel('Amplitud (dB)')
